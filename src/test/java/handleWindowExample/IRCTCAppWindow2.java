...
//		String win11 = (String) allWin.toArray()[0];
		...
		String win3 = (String)allWin.toArray()[2];
		String win4 = (String)allWin.toArray()[3];
		
		System.out.println("win1 window: " + win1);    // parentWindow
		System.out.println("win2 window: " + win2);
		System.out.println("win2 window: " + win3);
		System.out.println("win2 window: " + win4);
		
		Thread.sleep(5000);
		//Switch to window2
		
		driver.switchTo().window(win2);    //--------------------hotels
